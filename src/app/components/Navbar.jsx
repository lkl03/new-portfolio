    ...
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        <Link href="/" className="text-sm bg-black rounded-md p-1 font-semibold flex items-center justify-center">
          <span className="text-white mr-1">Luca</span>
          <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">Lago</span>
        </Link>
      </div>
      {/*Social*/}
      <div className="hidden md:flex gap-4 w-1/3">
        <Link href="https://github.com/lkl03" target='_blank'>
          <Image src="/github.png" alt="" width={24} height={24} />
        </Link>
        <Link href="https://dribbble.com/LucaLago_" target='_blank'>
          <Image src="/dribbble.png" alt="" width={24} height={24} />
        </Link>
        <Link href="https://www.linkedin.com/in/ll-luca-lago/" target='_blank'>
